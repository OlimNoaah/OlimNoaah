...
|:---:|:---|:---:|:---:|:---:|:---|:---:|
| **06.23-01** | [AWSKRUG 컨테이너 모임 EKS Hands-on Lab](https://www.meetup.com/awskrug/events/308226383/) | `모임` | 💳 | 🏢 서울 강남 | AWSKRUG | 📝 접수중 |
| **06.23-02** | [클라우드바리스타 커뮤니티 제11차 컨퍼런스](https://webinaro.co.kr/Event/343) | `기술일반` | 💳 | 🏢 제주 | 클라우드바리스타 | 📝 접수중 |
| **05.31-03** | [써머데이: 대학생 개발자들의 네트워킹 데이](https://event-us.kr/susc/event/105371) | `기술일반` | 🆓 | 🏢 서울 | SUSC | 📝 접수중 |
| **06.23-03** | [백엔드 개발자를 위한 NoSQL 데이터베이스 실전 클래스](https://www.wanted.co.kr/events/pre_challenge_be_32) | `백엔드` | 🆓 | 💻 온라인 | 원티드 | 📝 접수중 |
| **05.12-04** | [QA Korea Conference](https://www.qa-korea.com/qaconference2025) | `기술일반` | 💳 | 🏢 서울 강남 | QA Korea | 📝 접수중 |
| **06.23-04** | [2025 IT's Busan Day](https://onoffmix.com/event/325649) | `기술일반` | 💳 | 🏢 부산 해운대 | 엘리스랩 | 📝 접수중 |
| **06.21-06** | [2025 여름방학, 대학생 개발 스터디원 모집](https://event-us.kr/susc/event/106768) | `기술일반` | 🆓 | 💻 온라인 | SUSC | 📝 접수중 |
| **06.19-11** | [WWDC25의 중대 발표 내용 알아보기](https://developer.apple.com/events/view/TCSPG9PN8Y/dashboard) | `기술일반` | 🆓 | 💻 온라인 | APPLE | 📝 접수중 |
| **07.07-21** | [구글 스터디 잼 X 잇츠 스터디 - 크루원 모집](https://rsvp.withgoogle.com/events/2025-h2-google-cloud-ai-study-jam-kr/home) | `AI` | 🆓 | 💻 온라인 | 구글 | 📝 접수중 |
| **06.09-23** | [2025년 충청권 사이버보안 경진대회 참가자 모집](https://ccunictf.co.kr/) | `보안` | 🆓 | 💻🏢 온/오프라인 | 한국보건산업진흥원 | 📝 접수중 |

### 🗓️ 25년 08월

| 날짜 | 행사명 | 분류 | 비용 | 장소 | 주최 | 상태 |
|:---:|:---|:---:|:---:|:---:|:---|:---:|
| **04.01-08.08** | [UbuCon Korea 2025](https://event-us.kr/ubuntukr/event/101263) | `기술일반` | 💳 | 🏢 서울 | 우분투한국커뮤니티 | 📝 접수중 |
| **06.04-08.09** | [SUMMER CAMP 무료 세미나에 초대장을 보냅니다.](http://koreaitsecurity.co.kr/landing/summer_camp.asp) | `기술일반` | 🆓 | 🏢 동국대 | KOREA IT ACADEMY | 📝 접수중 |
| **08.15-17** | [PyCon Korea 2025](https://2025.pycon.kr/) | `기술일반` | 🆓 | 🏢 동국대 | 파이콘 | 🎯 예정 |

### 🗓️ 25년 09월

| 날짜 | 행사명 | 분류 | 비용 | 장소 | 주최 | 상태 |
|:---:|:---|:---:|:---:|:---:|:---|:---:|
| **09.23-25** | [AWS TechCamp](https://aws.amazon.com/ko/events/seminars/aws-techcamp/) | `클라우드` | 🆓 | 🏢 오프라인 | AWS | 🎯 예정 |

### 🗓️ 25년 10월

| 날짜 | 행사명 | 분류 | 비용 | 장소 | 주최 | 상태 |
|:---:|:---|:---:|:---:|:---:|:---|:---:|
| **03.24-10.31** | [개방형 클라우드 플랫폼(K-PaaS) 활용 공모전](https://contest.k-paas.org/) | `클라우드` `대회` | 🆓 | 💻 온라인 | K-PasaS | 📝 접수중 |

### 🗓️ 25년 11월

| 날짜 | 행사명 | 분류 | 비용 | 장소 | 주최 | 상태 |
|:---:|:---|:---:|:---:|:---:|:---|:---:|
| **11.25-27** | [AWS TechCamp](https://aws.amazon.com/ko/events/seminars/aws-techcamp/) | `클라우드` | 🆓 | 🏢 오프라인 | AWS | 🎯 예정 |

### 🗓️ 25년 12월

| 날짜 | 행사명 | 분류 | 비용 | 장소 | 주최 | 상태 |
|:---:|:---|:---:|:---:|:---:|:---|:---:|
| **03.31-12.31** | [네이버클라우드 Nclouder 모집](https://blog.naver.com/n_cloudplatform/223811699537) | `클라우드` | 🆓 | 💻 온라인 | 네이버 클라우드 | 📝 접수중 |
...
| 분류 | 📊 개수 | 주요 키워드 |
|:---:|:---:|:---|
| `AI` | 8개 | 인공지능, 머신러닝, ChatGPT, Copilot |
| `클라우드` | 12개 | AWS, 네이버클라우드, K-PaaS |
| `기술일반` | 15개 | 컨퍼런스, 네트워킹, 개발자 |
| `대회` | 6개 | 해커톤, 공모전, 경진대회 |
| `교육` | 4개 | 무료교육, 부트캠프, 아카데미 |
| `보안` | 3개 | 사이버보안, 정보보안 |
...
### ⚡ **마감임박 행사 알림**
> 📱 [구독 서비스](https://github.com/brave-people/Dev-Event-Subscribe)를 통해 놓치지 마세요!
